...
CONTRACT_PATH = os.path.normpath(os.path.join(_HERE, "..", "contracts", "crowd_fact_check.py"))


def load_contract():
    spec = importlib.util.spec_from_file_location("cfc_under_test", CONTRACT_PATH)
